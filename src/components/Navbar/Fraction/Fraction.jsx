...
const Fraction = (props) => {
  ...
  return (
    <>
      <button onClick={handleNumeratorChange} className={styles.numerator}>ЧИСЛИТЕЛЬ</button>
      <button onClick={handleDenominatorChange} className={styles.denominator}>ЗНАМЕНАТЕЛЬ</button>
    </>
  );
};
